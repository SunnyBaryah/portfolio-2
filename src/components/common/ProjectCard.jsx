...
export default function ProjectCard({ project }) {
  return (
    <div className="flex flex-col items-center justify-center gap-6">
      <div className="w-60 h-60 lg:w-80 lg:h-80 xl:w-96 xl:h-96 relative border-white border-2 overflow-hidden group rounded-xl shadow-xl">
        ...
        />
        <a
          className="absolute top-[12rem] lg:top-[17rem] xl:top-[21rem] right-0 bg-black text-blue-400 hover:text-white duration-150 inset-auto z-30 mx-4 px-3 py-1 rounded-md"
          href={project.link}
        >
          Link
        </a>
